...
public class ManualFlowControlServer {
  ...
  public static void main(String[] args) throws InterruptedException, IOException {
    ...
    StreamingGreeterGrpc.StreamingGreeterImplBase svc = new StreamingGreeterGrpc.StreamingGreeterImplBase() { //匿名类(abstract interface都可以new 一个匿名类{}  但是abstract interface是不能instance)
      @Override
