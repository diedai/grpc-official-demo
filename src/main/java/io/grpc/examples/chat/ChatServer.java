...
public class ChatServer {
  ...
  public static void main(String[] args) throws InterruptedException, IOException {
    ...
    ChatGrpc.ChatImplBase svc = new ChatGrpc.ChatImplBase() { //匿名类(abstract interface都可以new 一个匿名类{}  但是abstract interface是不能instance)
      @Override
      public StreamObserver<HelloRequest> sendMsg(final StreamObserver<HelloReply> responseObserver) {
