...
@rem ##########################################################################
@rem
@rem  hello-world-tls-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HELLO_WORLD_TLS_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute hello-world-tls-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLO_WORLD_TLS_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.helloworldtls.HelloWorldServerTls %CMD_LINE_ARGS%
...
:fail
rem Set variable HELLO_WORLD_TLS_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HELLO_WORLD_TLS_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
